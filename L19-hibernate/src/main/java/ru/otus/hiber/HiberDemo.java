...
/*
 * 1) Создать entity "Department" (название таблицы в бд departments). Поля в entity: departmentName (department_name), floorNo(floor_no)
 * 2) Реализовать интерфейс DepartmentDao. Должны поддерживаться методы ''insert(Department department)'', ''Department selectOne(Long id)''
 * 3) Поиграться с методами get(), load() в комбинации с detach()
 * */
